...
// QueryIssued chains the current query on the "issued" edge.
func (uq *UserQuery) QueryIssued() *JwtTokenQuery {
...
func (uq *UserQuery) Clone() *UserQuery {
	...
	return &UserQuery{
		...
		withIssued: uq.withIssued.Clone(),
...
// WithIssued tells the query-builder to eager-load the nodes that are connected to
// the "issued" edge. The optional arguments are used to configure the query builder of the edge.
func (uq *UserQuery) WithIssued(opts ...func(*JwtTokenQuery)) *UserQuery {
	query := (&JwtTokenClient{config: uq.config}).Query()
...
func (uq *UserQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*User, error) {
	...
	if query := uq.withIssued; query != nil {
		if err := uq.loadIssued(ctx, query, nodes,
			func(n *User) { n.Edges.Issued = []*JwtToken{} },
			func(n *User, e *JwtToken) { n.Edges.Issued = append(n.Edges.Issued, e) }); err != nil {
			return nil, err
		}
	}
	return nodes, nil
...
func (uq *UserQuery) loadIssued(ctx context.Context, query *JwtTokenQuery, nodes []*User, init func(*User), assign func(*User, *JwtToken)) error {
